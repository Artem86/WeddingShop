var Layout=function(){var f=function(){return navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/BlackBerry/i)||navigator.userAgent.match(/iPhone|iPad|iPod/i)||navigator.userAgent.match(/Opera Mini/i)||navigator.userAgent.match(/IEMobile/i)?!0:!1},n=function(){$(window).scrollTop()>60?$("body").addClass("page-on-scroll"):$("body").removeClass("page-on-scroll")},t=function(){var n,t;$(".navbar").offset().top>150&&$(".navbar-fixed-top").addClass("top-nav-collapse");$(window).scroll(function(){$(".navbar").offset().top>150?$(".navbar-fixed-top").addClass("top-nav-collapse"):$(".navbar-fixed-top").removeClass("top-nav-collapse")});n=0;n=$(".navbar-fixed-top").height()-20;$(".js_nav-item a").bind("click",function(t){var i=$($(this).attr("href")).offset().top;$("html, body").stop().animate({scrollTop:i-n},600);t.preventDefault()});t=$("body").scrollspy({target:".navbar-fixed-top",offset:n+2});$(window).scroll(function(){$(".navbar-collapse.in").collapse("hide")})},i=function(){var n=$(".carousel .item"),t=$(window).height();n.eq(0).addClass("active");n.height(t);n.addClass("full-screen");$(".carousel img").each(function(){var n=$(this).attr("src"),t=$(this).attr("data-color");$(this).parent().css({"background-image":"url("+n+")","background-color":t});$(this).remove()});$(window).on("resize",function(){t=$(window).height();n.height(t)})},r=function(){$("[data-auto-height]").each(function(){var n=$(this),i=$("[data-height]",n),t=0,r=n.attr("data-mode"),u=parseInt(n.attr("data-offset")?n.attr("data-offset"):0);i.each(function(){$(this).attr("data-height")=="height"?$(this).css("height",""):$(this).css("min-height","");var n=r=="base-height"?$(this).outerHeight():$(this).outerHeight(!0);n>t&&(t=n)});t=t+u;i.each(function(){$(this).attr("data-height")=="height"?$(this).css("height",t):$(this).css("min-height",t)});n.attr("data-related")&&$(n.attr("data-related")).css("height",n.height())})},u=function(){var n=$(".work-popup-overlay"),t=$(".work-popup-close"),i=$(".work-popup-trigger");i.on("click",function(){$(this).find(".work-popup-overlay").removeClass("work-popup-overlay-show");$(this).find(".work-popup-overlay").addClass("work-popup-overlay-show")});t.on("click",function(t){t.stopPropagation();n.removeClass("work-popup-overlay-show")})};return{init:function(){n();t();i();r();u();$(window).scroll(function(){n()})},getViewPort:function(){var n=window,t="inner";return"innerWidth"in window||(t="client",n=document.documentElement||document.body),{width:n[t+"Width"],height:n[t+"Height"]}}}}();$(document).ready(function(){Layout.init()});
